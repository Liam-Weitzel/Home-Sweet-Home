...
/* harmony import */ var _src_bar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(910);
/* harmony import */ var _src_events__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(27);
  ...
  async function checkForJS_Finish () {
    try {
      if ((0,_src_state__WEBPACK_IMPORTED_MODULE_1__/* .isShorts */ .ol)() || ((0,_src_buttons__WEBPACK_IMPORTED_MODULE_0__/* .getButtons */ .hS)()?.offsetParent && (0,_src_utils__WEBPACK_IMPORTED_MODULE_2__/* .isVideoLoaded */ .x8)())) {
        ...
        (0,_src_events__WEBPACK_IMPORTED_MODULE_4__/* .addLikeDislikeEventListener */ .G_)();
        await (0,_src_state__WEBPACK_IMPORTED_MODULE_1__/* .setInitialState */ .KY)();
        isSetInitialStateDone = true;
        (0,_src_utils__WEBPACK_IMPORTED_MODULE_2__/* .getBrowser */ .qs)().storage.onChanged.addListener(_src_events__WEBPACK_IMPORTED_MODULE_4__/* .storageChangeHandler */ .F6);
      }
    } catch (exception) {
...
function getDislikeButton() {
  ...
  'YTD-SEGMENTED-LIKE-DISLIKE-BUTTON-RENDERER'
    ...
    : (0,_utils__WEBPACK_IMPORTED_MODULE_1__/* .querySelector */ .R2)(_state__WEBPACK_IMPORTED_MODULE_0__/* .extConfig */ .zO.selectors.buttons.dislikeButton.notSegmented, getButtons())
}
...
if (isShorts() && mutationObserver.exists !== true) {
  (0,_utils__WEBPACK_IMPORTED_MODULE_2__/* .cLog */ .D2)("initializing mutation observer");
...
function isLikesDisabled() {
  ...
  return /^\D*$/.test((0,_buttons__WEBPACK_IMPORTED_MODULE_0__/* .getButtons */ .hS)().children[0].innerText);
}
