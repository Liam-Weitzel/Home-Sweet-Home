...
;// CONCATENATED MODULE: ./src/autofill/utils/utils.ts
...
class AutofillOverlayContentService {
    constructor() {
        ...
        this.setupMutationObserver = () => {
            ...
            const documentElementMutationObserver = new MutationObserver(this.handleDocumentElementMutationObserverUpdate);
